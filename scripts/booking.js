...
const [mondayButton, tuesdayButton, wednesdayButton, thursdayButton, fridayButton] =
  ['monday', 'tuesday', 'wednesday', 'thursday', 'friday'].map(id => document.getElementById(id));

const [fullButton, halfButton, clearButton] =
  ['full', 'half', 'clear-button'].map(id => document.getElementById(id));
